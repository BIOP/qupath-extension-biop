package qupath.ext.biop.transform;
...
public class RealTransformDeSerializer {
    ...
    public static Gson getRealTransformAdapter() {
        ...
        // TODO Fix Error
        GsonTools.SubTypeAdapterFactory factoryRealTransform = GsonTools.createSubTypeAdapterFactory(RealTransform.class, "type");//, RealTransform.class.getSimpleName());
