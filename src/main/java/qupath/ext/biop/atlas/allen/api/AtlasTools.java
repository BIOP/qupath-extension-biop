package qupath.ext.biop.atlas.allen.api;

import ij.gui.Roi;
import javafx.scene.paint.Color;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import qupath.ext.biop.atlas.allen.AllenOntologyJson;
import qupath.ext.biop.atlas.allen.utils.RoiSetLoader;
...
public class AtlasTools {
    ...
    public static List<PathObject> getFlattenedWarpedAtlasRegions(ImageData imageData, boolean splitLeftRight) {
        ...
        List<PathObject> annotations = rois.stream().map(roi -> {
            ...
            AllenOntologyJson.AllenBrainRegion region = ontology.getRegionFromId(object_id);
