...
def cellpose = Cellpose2D.builder( "none" ) // Can choose "None" if you want to train from scratch
                .channels( "Red" )  // or use work with .cellposeChannels( channel1, channel2 ) and follow the cellpose way
                .preprocess( ImageOps.Filters.gaussianBlur( 2 ) ) // Optional preprocessing QuPath Ops 
                .epochs( 50 )              // Optional: will default to 500
                .learningRate( 0.2 )        // Optional: Will default to 0.2
                .useOmnipose()                   // Use the omnipose instead
                .addParameter("cluster")
